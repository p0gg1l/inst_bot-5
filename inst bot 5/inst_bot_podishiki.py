...
class instagramBot():
    ...
    def get_subscribe(self, userpage):
        ...
        if self.xpath_exists(wrong_userpage):
            ...
            #внизу подписки
            koli4estvo_followers = browser.find_element_by_xpath("/html/body/div[1]/section/main/div/header/section/ul/li[3]/a")
...
my_bot.login()
my_bot.get_subscribe("https://www.instagram.com/rey.han.di/")
